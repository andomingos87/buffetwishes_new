...
/**
 * Wine-tone stats band — breaks the cream rhythm with `bg-primary text-cream`.
 * Same recipe as BuffetStats: editorial big-number treatment.
 */
export function EstruturaStats() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-primary py-20 text-cream sm:py-24">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 18% 25%, rgba(232,184,75,0.35), transparent 38%), radial-gradient(circle at 82% 75%, rgba(122,168,160,0.3), transparent 42%)",
        }}
      />
      <div
        aria-hidden
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -right-24 bottom-0 h-80 w-80 rounded-full bg-mint-500/15 blur-3xl"
      />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-3xl text-center">
          ...
          >
            Tudo o que sua festa
            <br className="hidden sm:block" />
            <span className="italic text-mustard-300">precisa caber</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
          ...
          >
            Um espaço pensado para que ninguém precise pedir licença — nem os
            pequenos, nem os pais, nem os fornecedores.
          </motion.p>
        </div>
