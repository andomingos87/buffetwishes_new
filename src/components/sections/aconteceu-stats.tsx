...
const STATS = [
  ...
  { value: "100%", label: "sorrisos garantidos", sub: "no fim do dia" },
] as const;

/**
 * Wine-tone stats band specific to /aconteceu — celebrates volume of
 * realized parties. Same recipe as BuffetStats: bg-primary text-cream,
 * radial glows, magazine pull-stat numbers.
 */
export function AconteceuStats() {
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-14 max-w-3xl text-center">
          ...
          >
            ...
            <span className="italic text-mustard-300">de festas reais</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
          ...
          >
            Cada número aqui é uma família que escolheu o Wishes para celebrar —
            e voltou pra contar.
          </motion.p>
        </div>
