...
export function CTAFinal() {
  ...
  return (
    ...
    >
      ...
      {/* Wine overlay — keeps brand color while letting photo breathe */}
      <div
        aria-hidden
      ...
      >
        ...
        >
          A gente reserva agora, você relaxa o resto do mês. No grande dia, é só
          chegar — nossa equipe cuida de tudo.
        </motion.p>
        ...
        {!reduce && (
          <motion.div
            ...
            className="mx-auto mt-14 h-px w-32 origin-center bg-gradient-to-r from-transparent via-mustard-300 to-transparent"
          />
        )}
        ...
        <motion.p
          ...
          className="mt-6 font-mono text-[11px] uppercase tracking-[0.22em] text-cream/50"
        >
